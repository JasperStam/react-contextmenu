    ...
    _createClass(SubMenu, [{
        ...
        value: function componentDidUpdate() {
            ...
            if (this.state.visible) {
                ...
                wrapper(function () {
                    var styles = _this2.getMenuPosition();
        ...
        value: function render() {
            ...
            var menuLinkProps = {
                href: '#',
                className: (0, _classnames2.default)(_helpers.cssClasses.menuLink, (_cx = {}, _defineProperty(_cx, _helpers.cssClasses.menuLinkDisabled, disabled), _defineProperty(_cx, _helpers.cssClasses.menuLinkActive, visible), _cx)),
            ...
            var subMenuProps = {
                ...
                className: _helpers.cssClasses.menu
            };
...
SubMenu.propTypes = {
    ...
    hoverDelay: _react.PropTypes.number
};
